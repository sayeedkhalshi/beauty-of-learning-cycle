...
It's a dynamic game. Anyone can build the next perspective to shift the narrative paths towards their desire to maintain their ainflow. Anyone can use anyone's narrative to design their own next path for their mainflow. So the game is much more dynamically open to engineering than we think.
...
# Fundamental Feelings engineering
...
# Story Engineering and Narrative Engineering

# Acquired Perspective Engineering
...
# Post Care Speculation Engineering and Pre Action

# Action Engineering

# Problem, Anxiety Engineering, Collapse, Hubris, Grudge Engineering

# Predictibility engineering

# Rejection, Trauma, Depression, 

# Post Trauma Engineering, HappinessEngineering

# Negative flow of dumbness engineering

# Intelligence Engineering - Rebuild and Authenticity 

# Requirements Perspectives Engineering

# Post Intelligent Speculation Engineering and pre action engineering

# Action Projection Loop Engineering Through Whole cycle

# Unintentionalism Engineering

# Awareness engineering 

# Awakening Engineering

# Desire Engineering

# Intentionalism engineering
